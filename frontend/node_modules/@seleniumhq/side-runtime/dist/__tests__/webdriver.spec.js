...
describe('webdriver executor', () => {
    it('should implement all the Selenium commands', () => {
        Object.keys(side_model_1.Commands).forEach((command) => {
            if (!(command in commands_1.ControlFlowCommandNames)) {
                expect(() => {
                    if (
                    // @ts-expect-error I'll solve this later
                    !webdriver_1.default.prototype[`do${command.charAt(0).toUpperCase() + command.slice(1)}`]) {
    ...
    describe.each([
        ['chrome', webdriver_testkit_1.createHeadlessChrome],
        ['firefox', webdriver_testkit_1.createHeadlessFirefox],
    ])('commands on %s', (_browserName, createDriver) => {
        let driver, executor, variables;
        beforeAll(async () => {
            variables = new variables_1.default();
            driver = await createDriver();
            executor = new webdriver_1.default({ driver });
        ...
        describe('accept alert', () => {
            it('should dismiss an alert', async () => {
                ...
                const element = await driver.findElement(selenium_webdriver_1.By.css('button'));
                await element.click();
        ...
        describe('add selection', () => {
            it('should select a single select item', async () => {
                ...
                const element = await driver.findElement(selenium_webdriver_1.By.css('select'));
            ...
            it('should add to a multi select element', async () => {
                await driver.get(`http://localhost:${port}/select.html`);
                const element = await driver.findElement(selenium_webdriver_1.By.id('mult'));
                expect((await driver.executeScript('return arguments[0].selectedOptions', element)).length).toBe(0);
                await executor.doAddSelection('id=mult', 'label=Volvo');
                const selections = await driver.executeScript('return arguments[0].selectedOptions', element);
                ...
                expect((await driver.executeScript('return arguments[0].selectedOptions', element)).length).toBe(1);
                await executor.doAddSelection('id=mult', 'value=audi');
                expect((await driver.executeScript('return arguments[0].selectedOptions', element)).length).toBe(2);
            });
        });
        ...
        describe('click and click at', () => {
            it('should click', async () => {
                ...
                const r = await driver.findElement(selenium_webdriver_1.By.id('r'));
        ...
        describe.skip('drag and drop', () => {
            ...
            it('should drag and drop an element', async () => {
                ...
                const r = await driver.findElement(selenium_webdriver_1.By.id('target'));
        ...
        describe('edit content', () => {
            it('should set the content of a content editable element', async () => {
                ...
                const r = await driver.findElement(selenium_webdriver_1.By.id('c'));
        ...
        describe('mouse down and mouse down at', () => {
            it('it should move and press the left mouse button on an element', async () => {
                ...
                const r = await driver.findElement(selenium_webdriver_1.By.id('a'));
        ...
        describe('mouse out', () => {
            it('should move out of an element through the top', async () => {
                ...
                const r = await driver.findElement(selenium_webdriver_1.By.id('cont'));
            ...
            it('should move out of an element through the bottom', async () => {
                await driver.manage().window().setRect({ height: 1000, width: 1000 });
                await driver.get(`http://localhost:${port}/mouse/out.html?x=0&y=0&w=1000`);
                const r = await driver.findElement(selenium_webdriver_1.By.id('cont'));
                await driver.actions({ bridge: true }).move({ origin: r }).perform();
                await executor.doMouseOut('id=cont');
            ...
            it('should move out of an element through the left', async () => {
                ...
                await driver.get(`http://localhost:${port}/mouse/out.html?x=1&y=0&w=1000&h=400`);
                const r = await driver.findElement(selenium_webdriver_1.By.id('cont'));
                await driver.actions({ bridge: true }).move({ origin: r }).perform();
                await executor.doMouseOut('id=cont');
            ...
            it('should throw if the element takes up the entire viewport', async () => {
                ...
                await driver.get(`http://localhost:${port}/mouse/out.html?x=0&y=0&w=500&h=500`);
        ...
        describe('remove selection', () => {
            ...
            it('should remove from a multi select element', async () => {
                await driver.get(`http://localhost:${port}/select.html`);
                const element = await driver.findElement(selenium_webdriver_1.By.id('mult'));
                const opt1 = await element.findElement(selenium_webdriver_1.By.css('option:nth-child(1)'));
                const opt4 = await element.findElement(selenium_webdriver_1.By.css('option:nth-child(4)'));
                await opt1.click();
                await opt4.click();
                expect((await driver.executeScript('return arguments[0].selectedOptions', element)).length).toBe(2);
        ...
        describe('wait for element editable', () => {
            it('should wait for an element to be editable', async () => {
                ...
                const button = await driver.findElement(selenium_webdriver_1.By.id('b'));
                await button.click();
                await executor.doWaitForElementEditable('id=t', '500');
                const input = await driver.findElement(selenium_webdriver_1.By.id('t'));
        ...
        describe('wait for element present', () => {
            it('should wait for an element to appear', async () => {
                ...
                expect(await driver.findElement(selenium_webdriver_1.By.id('t'))).toBeInstanceOf(selenium_webdriver_1.WebElement);
            });
            ...
            it('should wait for an element to disappear', async () => {
                ...
                await expect(driver.findElement(selenium_webdriver_1.By.id('t'))).rejects.toThrow();
            });
        ...
        describe('wait for element visible', () => {
            ...
            it('should wait for an element to be invisible', async () => {
                ...
                const elem = await driver.findElement(selenium_webdriver_1.By.id('t'));
