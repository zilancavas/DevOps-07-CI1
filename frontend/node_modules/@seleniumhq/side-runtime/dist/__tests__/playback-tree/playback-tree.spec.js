...
describe('Control Flow', () => {
    describe('Process', () => {
        describe('Linked List Validation', () => {
            test('nodes contain command references and levels', () => {
                ...
                let stack = (0, playback_tree_1.createCommandNodesFromCommandStack)(input);
            ...
            test('while-if-end-end', () => {
                let input = [
                    ...
                    createCommand('command'),
                    createCommand(commands_1.ControlFlowCommandNames.end),
                    createCommand(commands_1.ControlFlowCommandNames.end), // 4
                ];
                let stack = (0, playback_tree_1.createCommandNodesFromCommandStack)(input);
                expect(stack[0].next).toBeUndefined();
                expect(stack[0].right).toEqual(stack[1]);
            ...
            test('while-if-end-command-end', () => {
                let input = [
                    ...
                    createCommand(commands_1.ControlFlowCommandNames.end),
                    createCommand('command'),
                    createCommand(commands_1.ControlFlowCommandNames.end), // 5
                ];
                let stack = (0, playback_tree_1.createCommandNodesFromCommandStack)(input);
                expect(stack[0].next).toBeUndefined();
                expect(stack[0].right).toEqual(stack[1]);
            ...
            test('times-command-end', () => {
                let input = [
                    createCommand(commands_1.ControlFlowCommandNames.times),
                    createCommand('command'),
                    createCommand(commands_1.ControlFlowCommandNames.end),
                ];
                let stack = (0, playback_tree_1.createCommandNodesFromCommandStack)(input);
    ...
    describe('Processed', () => {
        it('knows if there are control flow commands within the command stack', () => {
            ...
            const tree = (0, playback_tree_1.createPlaybackTree)(input);
        ...
        it('do-command-repeatIf-end skips do', () => {
            ...
            let tree = (0, playback_tree_1.createPlaybackTree)(input);
        ...
        it('populated tree exists with correct values', () => {
            ...
            expect(tree.startingCommandNode.left.next.left.next.command).toEqual(input[6]); //                              do
            expect(tree.startingCommandNode.left.next.left.next.next.next.right
                .command).toEqual(input[9]); //              do -> while -> command
            expect(tree.startingCommandNode.left.next.left.next.next.next.left
                .command).toEqual(input[10]); //              do -> while -> end
            expect(tree.startingCommandNode.left.next.left.next.next.next.left
                .next.right.command).toEqual(input[6]); //    repeatIf -> do
            expect(tree.startingCommandNode.left.next.left.next.next.next.left
                .next.left.command).toEqual(input[12]); //    repeatIf -> end
            expect(tree.startingCommandNode.left.next.left.next.next.next.left
                .next.left.next).toBeUndefined(); //          end
            expect(tree.startingCommandNode.left.next.left.next.next.next.left
                .next.left.right).toBeUndefined(); //         end
            expect(tree.startingCommandNode.left.next.left.next.next.next.left
                .next.left.left).toBeUndefined(); //          end
        });
    });
});
//# sourceMappingURL=playback-tree.spec.js.map