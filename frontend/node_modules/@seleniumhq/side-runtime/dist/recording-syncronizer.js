...
function createRecorderSyncronizer({ sessionId, executeAsyncScript, switchToWindow, getWindowHandle, logger, }) {
    ...
    async function onWindowSwitched({ windowHandle }) {
        if (pendingWindows[windowHandle]) {
            ...
            logger.error(`Tried to switch to window handle ${windowHandle} without it appearing first (onWindowAppeared was not called for it)`);
        }
    }
...
exports.default = createRecorderSyncronizer;
//# sourceMappingURL=recording-syncronizer.js.map