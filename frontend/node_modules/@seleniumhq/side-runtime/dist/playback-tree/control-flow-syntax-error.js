...
exports.ControlFlowSyntaxError = void 0;
class ControlFlowSyntaxError extends SyntaxError {
    constructor(message, index) {
        super(message);
        this.index = index;
    }
}
exports.ControlFlowSyntaxError = ControlFlowSyntaxError;
//# sourceMappingURL=control-flow-syntax-error.js.map