...
exports.interpolateScript = exports.interpolateString = exports.preprocessArray = exports.composePreprocessors = void 0;
...
function composePreprocessors(...args) {
    ...
    if (params.length === 0) {
        ...
        return function preprocess(target, ...args) {
            return func.call(this, runPreprocessor(params[0], target, this.variables), ...args);
        };
    }
    else if (params.length === 2) {
        return function preprocess(target, value, ...args) {
            return func.call(this, runPreprocessor(params[0], target, this.variables), runPreprocessor(params[1], value, this.variables), ...args);
        };
    }
    else {
        return function preprocess(target, value, options) {
            ...
            return func.call(this, runPreprocessor(params[0], target, this.variables), runPreprocessor(params[1], value, this.variables), preprocessObject(params[2], options, this.variables));
        };
    }
}
exports.composePreprocessors = composePreprocessors;
...
function preprocessArray(interpolator) {
...
function interpolateScript(script, variables) {
