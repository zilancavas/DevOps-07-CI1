...
function Satisfies(strGolden, strVersion) {
    const golden = semver_1.default.coerce(strGolden);
    const version = semver_1.default.coerce(strVersion);
    if (strGolden === strVersion) {
        return;
    }
    else if (semver_1.default.satisfies(version, `^${semver_1.default.major(golden)}`)) {
        return semver_1.default.gt(version, golden)
        ...
        throw new Error(semver_1.default.gt(version, golden)
